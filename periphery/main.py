...
DEFAULT_CONFIG_PATH = "../Arena/configurations/periphery_config.json"


class Config:
    log_level = logging.INFO  # Use logging.DEBUG to log every message passed through the bridge.
    ...
    def __init__(self, config_path, mqtt_host, mqtt_port):
        self.arena_config_path = config_path
        self.mqtt = {
...
if __name__ == "__main__":
    ...
    config = Config(args.config, args.mqtt_host, int(args.mqtt_port))
