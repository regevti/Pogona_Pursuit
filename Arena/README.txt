...
3. Configure your Python installation. From a command line, run the following
   ...
   For example, with Python 3.7, install a supported Pillow using the following command:

   ex. py -3.7 -m pip install Pillow==5.2.0
...
For example, if PySpin is installed for Python 3.7, run a preinstalled example
using the following:
...
2. Install library dependencies for PySpin: numpy and matplotlib. NumPy is a
  ...
  Note: some versions of Pillow might NOT support some Python versions. 
   ...
   ex. python3.7 -m pip install Pillow==5.2.0
