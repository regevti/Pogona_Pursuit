...
def configure_trigger(cam):
    ...
    try:
        ...
        if CHOSEN_TRIGGER == TriggerType.SOFTWARE:
            ...
            node_trigger_source_hardware = node_trigger_source.GetEntryByName('Line1')
            ...
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    if device_serial_number:
                        filename = 'output/Trigger-%s-%d-%s.jpg' % (device_serial_number, i, time.time())
                    else:  # if serial number is empty
                        filename = 'output/Trigger-%d-%s.jpg' % (i, time.time())
